...
def wrapper(root,game_sha,exe_sha):
    ...
    source+="install(function()return platform(base)end,native,policy,profile,signatures,{revision='v16',game_sha256='%s',exe_sha256='%s'},image_native,images,image_signatures,dependencies)\n"%(game_sha,exe_sha)
    return source
